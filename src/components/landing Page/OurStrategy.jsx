...
import BoyGlobe from '../../assets/images/BoyGlobe.png'
  ...
  return (
    <div className='pb-28'>
     <div className='flex flex-col items-center gap-3 pt-[35px]'>
         {/* Header */}
      <div className=' w-[458px] h-[70px] text-center font-bold text-6xl text-[#424531]'>
        Our Strategy
      </div>
      {/* Subheader */}
      <p className='w-[725px] h-[36px] text-center font-medium italic text-2xl'>
     ...
     <div className='flex pt-[100px] pl-[78px] mr-14'>
        ...
        <div className='pl-5'>
            <div>
                ...
                <p className='w-[721px] h-[216px] font-medium text-2xl mt-10'>
            ...
            <div className='flex gap-4 mt-[50px]'>
                ...
                <div className='w-[721px]'>
                    ...
                    <p className='w-[700px] h-[288px] mt-9 font-medium text-2xl '>
